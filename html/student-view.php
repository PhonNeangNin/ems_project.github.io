...
if (isset($_SESSION['role']) && $_SESSION['role'] == "student") {
    ...
    $getStudentById = getStudentById($id, $conn);
    $objstudentByGrade = getStudentByGrade($grade, $conn);
?>
<!DOCTYPE html>
                  ...
                  <div class="card mb-4">
                    ...
                    <div class="table-responsive text-nowrap">
                      <table class="table">
                        ...
                        <?php
                          if($objstudentByGrade != NULL){
                            foreach ($objstudentByGrade as $stu) {

                          ?>  
                            <tr>
                              <td><i class="fab fa-angular fa-lg text-danger me-3"></i> <strong><?= strtoupper($stu['fname']) ?></strong></td>
                              <td><strong><?= strtoupper($stu['lname']) ?></td>
                              <td><strong><?= strtoupper($stu['username']) ?></td>
                              <td><strong><?= strtoupper($stu['grade']) ?></td>
                              <td>
