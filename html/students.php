...
// if (isset($_SESSION['role']) && $_SESSION['role'] == "Admin") {
    ...
    $objsection = getAllsection($conn);
    $objstudent = getAllStudent($conn);
...
>
  ...
  <body>
          ...
          ?>
            ...
            <div class="content-wrapper">
              ...
              <div class="container-xxl flex-grow-1 container-p-y">
                <h4 class="fw-bold py-3 mb-4"><span class="text-muted fw-light">Student/</span> Enter Student Information</h4>
                <div class="row">
                  <div class="col-xl">
                    <div class="card mb-4">
                      ...
                      <div class="table-responsive text-nowrap">
                        <table class="table">
                          ...
                          <?php
                            if($objstudent!= NULL){
                              foreach ($objstudent as $student) {
                            
                            ?>  
                            <tr>
                              <td><i class="fab fa-angular fa-lg text-danger me-3"></i> <strong><?= strtoupper($student['fname']) ?></strong></td>
                              <td><strong><?= strtoupper($student['lname']) ?></td>
                              <td><strong><?= strtoupper($student['username']) ?></td>
                              <td><strong><?= strtoupper($student['grade']) ?></td>
                              <td>
                              ...
                              <div class="dropdown">
                                  ...
                                  <button
                                    ...
                                    data-emailaddress = "<?=$student['email_address']?>"
                                    data-id = "<?=$student['student_id']?>"
                                    onclick="fn_update(this)"
                                    >Edit
                                  </button>
                                  <a href="req/student-delete.php?student_id=<?= $student['student_id'] ?>&username=<?= $student['username'] ?>&password=<?= $student['password'] ?>">
                                    <button 
                                    type="button"
                          ...
                          <?php
                            ...
                            ?>  
                              <tr>
                                ...
                                <td>
                                  <a href="student-view.php?grade=<?= $student['grade'] ?>&student_id=<?= $student['student_id'] ?>">
                                  <button 
                                    type="button"
                    ...
                    <div class="card mb-4">
                      ...
                      <div class="table-responsive text-nowrap">
                        <table class="table">
                          ...
                          <tbody class="table-border-bottom-0">
                              <?php
                                if ($getTeacherByUFL != null) {
                                    $i = 0;
                                    foreach($getTeacherByUFL as $tech) {
                                      $i++;
                              ...
                              ?>
                                ...
                                <tr>
                                  ...
                                  <td><a href="teacher-page.php?class=<?= $tech['class'] ?>"><?= $tech['class'] ?></a></td>
                                </tr>
          ...
          <div class="modal fade" id="modalCenter" tabindex="-1" aria-hidden="true">
            <div class="modal-dialog modal-dialog-centered" role="document">
              <div class="modal-content">
                ...
                <div class="card">
                <div class="card-body">
                <form id="formAuthentication" class="mb-3" action="req/student.php" method="POST">
                  <div class="mb-3">
                  ...
                  <div class="row">
                    <div class="mb-3">
                          ...
                          <select class="form-select" id="subjectgrade" aria-label="Default select example" name="grade">
                            <?php foreach ($objGrade as $ogr):?>
                              <option value="<?=$ogr['grade']?>-<?=$ogr['grades_code']?>"><?=$ogr['grade']?>-<?=$ogr['grades_code']?></option>
                            <?php endforeach?>
                          </select>
                        </div>
                  </div>
                  ...
                  <div class="row">
                    <div class="mb-3">
                          ...
                          <select class="form-select" id="subjectgrade" aria-label="Default select example" name="section">
                            <?php foreach ($objsection as $osec):?>
                              <option value="<?=$osec['section']?>"><?=$osec['section']?></option>
                            <?php endforeach?>
                          </select>
                        </div>
                  </div>

                  <div class="row g-2" id="updatestudent" style="display: none;">
                      <div class="col mb-0">
                  ...
                  <button type="submit" class="btn btn-primary d-grid w-100">Add Student</button>
                </form>
                </div>
                </div>
              </div>
    ...
    <!-- Vendors JS -->
    <script src="../html/js/student.js"></script>
    <!-- Main JS -->
