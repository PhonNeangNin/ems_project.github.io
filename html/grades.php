...
>
  ...
  <body>
        ...
        <div class="layout-page">
          ...
          <div class="content-wrapper">
            ...
            <div class="container-xxl flex-grow-1 container-p-y">
              <h4 class="fw-bold py-3 mb-4"><span class="text-muted fw-light">Forms/</span>Grade Information</h4>
              <div class="row">
                <div class="col-xl">
                  <div class="card mb-4">
                    <h5 class="card-header">Light Table Grade</h5>
                    <div class="table-responsive text-nowrap">
                      <table class="table">
                        ...
                        <tbody class="table-border-bottom-0">
                          ...
                          ?>
                          <tr>
                            <td><i class="fab fa-angular fa-lg text-danger me-3"></i> <strong><?= strtoupper($grade['grade'])?>-<?= strtoupper($grade['grades_code']) ?></strong></td>
                            </td>
                            <td><span class="badge bg-label-primary me-1"><?= strtoupper($grade['grades_code']) ?></span></td>
                            <td>
                              <div class="dropdown">
                                <div class="buy-now">
                                <button
                                  ...
                                  data-id = "<?=$grade['grades_id']?>"
                                  data-code = "<?=$grade['grades_code']?>"
                                  data-grade = "<?=$grade['grade'] ?>"
                                  onclick="fn_update(this)"
                                  >Edit
                                </button>
                                <a href="req/grade-delect.php?grade_id=<?= $grade['grades_id'] ?>">
                                  <button 
                                  type="button"
          ...
          <div class="modal-dialog modal-dialog-centered" role="document">
            <div class="modal-content">
              <div class="modal-header">
                <h5 class="modal-title" id="modalCenterTitle">Add New Grade</h5>
                <button
                  type="button"
                  class="btn-close"
              ...
              <form id="formClass" action="req/grades.php" method="POST">
                <div class="modal-body">
                  <div class="row">
                    <div class="col mb-3">
                      <label for="nameWithTitle" class="form-label">Grade Code</label>
                      <input
                        type="text"
                        id="Gradecode"
                        class="form-control"
                  ...
                  <div class="row g-2">
                    <div class="col mb-0">
                      <label for="emailWithTitle" class="form-label">Grade</label>
                      <input
                        type="text"
                        id="Grade"
                        class="form-control"
                  ...
                  <div class="row g-2" id="updategrade" style="display: none;">
                    <div class="col mb-0">
    ...
    <!-- Vendors JS -->
    <script src="../html/js/grades.js"></script>
    <!-- Main JS -->
