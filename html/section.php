...
>
  ...
  <body>
      ...
      <div class="layout-container">
        ...
        <div class="layout-page">
          ...
          <div class="container-xxl flex-grow-1 container-p-y">
              <h4 class="fw-bold py-3 mb-4"><span class="text-muted fw-light">Forms/</span>Section Information</h4>
              <div class="row">
                <div class="col-xl">
                  <div class="card mb-4">
                    <h5 class="card-header">Light Table Section</h5>
                    <div class="table-responsive text-nowrap">
                      <table class="table">
                        ...
                        <?php
                          ...
                          ?>
                          <tr>
                            <td><i class="fab fa-angular fa-lg text-danger me-3"></i> <strong><?= strtoupper($sec['section']) ?></strong></td>
                            </td>
                            ...
                            <td>
                              <div class="dropdown">
                                ...
                                <a href="req/section-delete.php?section_id=<?= $sec['section_id'] ?>">
                                  <button 
                                  type="button"
       ...
       <div class="modal fade" id="modalCenter" tabindex="-1" aria-hidden="true">
          <div class="modal-dialog modal-dialog-centered" role="document">
            <div class="modal-content">
              ...
              <form id="formClass" action="req/section.php" method="POST">
                <div class="modal-body">
                  ...
                  <div class="row g-2" id="updatesection" style="display: none;">
                    <div class="col mb-0">
    ...
    <script src="../html/js/section.js"></script>
    <!-- Vendors JS -->
