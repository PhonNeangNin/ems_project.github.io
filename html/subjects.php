...
>
  ...
  <body>
        ...
        <div class="layout-page">
          ...
          <div class="content-wrapper">
            ...
            <div class="container-xxl flex-grow-1 container-p-y">
              <h4 class="fw-bold py-3 mb-4"><span class="text-muted fw-light">Subject/</span> Subject Information</h4>

              <div class="row">
                <div class="col-xl">
                  <div class="card mb-4">
                    <h5 class="card-header">Light Table Subject</h5>
                    <div class="table-responsive text-nowrap">
                      <table class="table">
                        ...
                        <?php
                          if($objSubject!= NULL){
                            foreach ($objSubject as $Subject) {
                          
                          ?>   
                          <tr>
                            <td><i class="fab fa-angular fa-lg text-danger me-3"></i> <strong><?= strtoupper($Subject['subject_name']) ?></strong></td>
                            <td><strong><?= strtoupper($Subject['subject_code']) ?></strong></td>
                            <td><strong><?= strtoupper($Subject['grade']) ?></strong></td>
                            ...
                            <div class="dropdown">
                                ...
                                <a href="req/subject-delete.php?subject_id=<?= $Subject['subject_id'] ?>">
                                  <button 
                                  type="button"
      ...
      <div class="modal-dialog modal-dialog-centered" role="document">
        <div class="modal-content">
          <div class="modal-header">
            <h5 class="modal-title" id="modalCenterTitle">Subject</h5>
            <button
              type="button"
              class="btn-close"
          ...
          <form id="formClass" action="req/subjects.php" method="POST">
            <div class="modal-body">
              <div class="row">
                <div class="col mb-3">
                  <label for="nameWithTitle" class="form-label">Subject name</label>
                  <input
                    type="text"
                    id="subjectname"
                    class="form-control"
              ...
              <div class="row g-2">
                <div class="col mb-0">
                  <label for="emailWithTitle" class="form-label">Subject Code</label>
                  <input
                    type="text"
                    id="subjectcode"
                    class="form-control"
              ...
              <div class="row">
                ...
                <div class="row g-2" id="updatesubject" style="display: none;">
                    <div class="col mb-0">
    ...
    <!-- Vendors JS -->
    <script src="../html/js/subject.js"></script>
    <!-- Main JS -->
