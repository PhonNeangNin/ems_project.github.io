...
session_start();
    ...
    $objUser = getTeacherIDByOneUFL($_SESSION['username'], 
              $_SESSION['fname'], $_SESSION['lname'], $conn);

    $getAdminByUFL = null;
    $getStudentByUFL = null;
    $getTeacherByUFL = null;
              ...
              <div class="row">
                <div class="col-md-12">
                  ...
                  <div class="card mb-4">
                    ...
                    <hr class="my-0" />
                    <div class="card-body">
                      <form id="formAuthentication" class="mb-3" action="req/account.php" method="POST">
                        
                        <?php
                         if (isset($_SESSION['role']) && $_SESSION['role'] == "Admin") {
                            $getAdminByUFL = getAdminByOneUFL($_SESSION['username'], 
                                              $_SESSION['fname'], $_SESSION['lname'], $conn);
                         } else if (isset($_SESSION['role']) && $_SESSION['role'] == "student") {
                            $getStudentByUFL = getStudentByOneUFL($_SESSION['username'], 
                                  $_SESSION['fname'], $_SESSION['lname'], $conn);
                         } else if (isset($_SESSION['role']) && $_SESSION['role'] == "teachers") {
                            $getTeacherByUFL = getTeacherByOneUFL($_SESSION['username'], 
                                               $_SESSION['fname'], $_SESSION['lname'], $conn);
                         } else {
                        ...
                        <div class="mb-3">
                          ...
                          <input
                            ...
                            ?>
                              value="<?= $getTeacherByUFL['fname']?>"
                            <?php
                              } else if ($getStudentByUFL != null) {
                            ?>
                             value="<?= $getStudentByUFL['fname']?>"
                            <?php
                              } else {
                            ?>
                              value="<?= $getAdminByUFL['firstname']?>"
                            <?php
                              }
                            ?>
                            autofocus
                        ...
                        <div class="mb-3">
                          ...
                          <input
                            ...
                            <?php
                              if ($getTeacherByUFL != null) {
                            ?>
                              value="<?= $getTeacherByUFL['lname']?>"
                            <?php
                              } else if ($getStudentByUFL != null) {
                            ?>
                             value="<?= $getStudentByUFL['lname']?>"
                            <?php
                              } else {
                            ?>
                              value="<?= $getAdminByUFL['lastname']?>"
                            <?php
                              }
                            ?>
                            autofocus
                        ...
                        <div class="mb-3">
                          ...
                          <input
                            ...
                            <?php
                              if ($getTeacherByUFL != null) {
                            ?>
                              value="<?= $getTeacherByUFL['address']?>"
                            <?php
                              } else if ($getStudentByUFL != null) {
                            ?>
                             value="<?= $getStudentByUFL['address']?>"
                            <?php
                              }
                            ?>
                            autofocus
                        ...
                        <div class="mb-3">
                          ...
                          <input
                            ...
                            <?php
                              if ($getTeacherByUFL != null) {
                            ?>
                              value="<?= $getTeacherByUFL['email_address']?>"
                            <?php
                              } else if ($getStudentByUFL != null) {
                            ?>
                             value="<?= $getStudentByUFL['email_address']?>"
                            <?php
                              }
                            ?>
                            autofocus
                        ...
                        <div class="mb-3">
                            ...
                            <?php
                                if ($getTeacherByUFL != null) {
                            ?>
                              value="<?= $getTeacherByUFL['username']?>"
                            <?php
                              } else if ($getStudentByUFL != null) {
                            ?>
                             value="<?= $getStudentByUFL['username']?>"
                            <?php
                              } else {
                            ?>
                              value="<?= $getAdminByUFL['username']?>"
                            <?php
                              }
                            ?>
                            autofocus
                            ...
                            <div class="col mb-0">
                              ...
                              <input
                                ...
                                <?php
                                  if ($getTeacherByUFL != null) {
                                ?>
                                    value="<?= $getTeacherByUFL['teachers_id']?> "
                                <?php
                                  } else if ($getStudentByUFL != null) {
                                ?>
                                    value="<?= $getStudentByUFL['student_id']?>"
                                <?php
                                  }
                                ?>
                              />
                        ...
                        <button type="submit" class="btn btn-primary d-grid w-100">Save change</button>
                      </form>
                    </div>
                    <!-- /Account -->
                  </div>
