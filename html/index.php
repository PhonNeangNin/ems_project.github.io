...
<?php
    ...
    $getCountStudents = getCountStudents($conn);
    $getCountTeacher = getCountTeacher($conn);
    $getCountClass = getCountClass($conn);
    $getCountSubject = getCountSubject($conn);
              ...
              <div class="row">
                    ...
                    <div class="col-lg-6 col-md-12 col-6 mb-4">
                      <div class="card">
                        <div class="card-body">
                          ...
                          <?php
                            if ($getCountStudents != null) {
                          ?>
                            <h3 class="card-title mb-2"><?=$getCountStudents['item']?></h3>
                          <?php
                           }
                          ?>
                        </div>
                    ...
                    <div class="col-lg-6 col-md-12 col-6 mb-4">
                      <div class="card">
                        <div class="card-body">
                          ...
                          <span>Teachers</span>
                          <?php
                            if ($getCountTeacher != null) {
                          ?>
                            <h3 class="card-title mb-2"><?=$getCountTeacher['item']?></h3>
                          <?php
                           }
                          ?>
                        </div>
                ...
                <div class="col-12 col-lg-8 order-2 order-md-3 order-lg-2 mb-4">
                  <div class="card">
                    ...
                    <button class="btn btn-primary mb-3" style="margin-top: 10px; margin-left: 20px;" 
                        onclick="window.print()">Print user
                    </button>
                    ...
                    <div class="col-6 mb-4">
                      <div class="card">
                        <div class="card-body">
                          ...
                          <span class="d-block mb-1">Clases</span>
                          <?php
                             if ($getCountClass != null) {

                          ?>
                            <h3 class="card-title text-nowrap mb-2"><?= $getCountClass['item']?></h3>
                          <?php
                            }
                          ?>
                        </div>
                    ...
                    <div class="col-6 mb-4">
                      <div class="card">
                        <div class="card-body">
                          ...
                          <?php
                             if ($getCountSubject != null) {

                          ?>
                            <h3 class="card-title text-nowrap mb-2"><?= $getCountSubject['item']?></h3>
                          <?php
                            }
                          ?>
                        </div>
