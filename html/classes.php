...
>
  ...
  <body>
                    ...
                    <div class="table-responsive text-nowrap">
                      <table class="table">
                        ...
                        <tbody class="table-border-bottom-0">
                         ...
                         <?php
                          if($objClass!= NULL){
                            foreach ($objClass as $classes) {
                          
                          ?>                      
                          <tr>
                            <td><i class="fab fa-angular fa-lg text-danger me-3"></i><strong><?= strtoupper($classes['grade']) ?>(<?= strtoupper($classes['section']) ?>)</strong></td>
                            ...
                            <td class="w-20">
                              <div class="buy-now">
                                <button
                                  ...
                                  data-classid="<?=$classes['class_id']?>"
                                  onclick="fn_updateclass(this)"
                                  >Edit
                                </button>
                                <a href="req/classes-delete.php?class_id=<?= $classes['class_id'] ?>">
                                  <button 
                                  type="button"
          ...
          <div class="modal-dialog modal-dialog-centered" role="document">
            <div class="modal-content">
              <div class="modal-header">
                <h5 class="modal-title" id="modalCenterTitle">Class</h5>
                <button
                  type="button"
                  class="btn-close"
              ...
              <form id="formClass" action="req/classes.php" method="POST">
                <div class="modal-body">
                  ...
                  <div class="mb-3">
                        ...
                        <select class="form-select" id="exampleFormControlSelect1" aria-label="Default select example" name="section">
                          <?php foreach ($objSection as $oses):?>
                            <option value="<?=$oses['section']?>"><?=$oses['section']?></option>
                          <?php endforeach?>
                        </select>
                      </div>
                  </div>
                  <div class="row g-2" id="updateclass" style="display: none;">
                    <div class="col mb-0">
    ...
    <!-- / Layout wrapper -->
    <script>
    function fn_updateclass(ele){
      console.log(ele);
    
      let section = $(ele).data('section');
      let classid = $(ele).data('classid');
    ...
    // $('#section').val(section);
      ...
      $('#modalCenterTitle').text("Update Classes");
    }
    function updateclass(){
      $('#updateclass').css('display', 'none');
      $('#modalCenterTitle').text("Add Classes");
